...
Future<void> copiarDocumentos() async {
  final documentosCopiar = [
    'V1011-1073', 'V1012-1073', 'V1019-1073', 'V1029-1073', 'V1033-030c',
    'V1033-1073', 'V1035-0b6f', 'V1036-1073', 'V1037-030c', 'V1037-1073',
    'V1038-030c', 'V1038-1073', 'V1039-030c', 'V1043-030c', 'V1045-030c',
    'V1046-030c', 'V1046-1073', 'V1055-0b6f', 'V1060-0b6f', 'V1069-1073',
    'V1070-0b6f', 'V1070-1073', 'V1071-0b6f', 'V1072-1073', 'V1074-0b6f',
    'V1075-0b6f', 'V1076-030c', 'V1076-0b6f', 'V1077-1073', 'V1078-1073',
    'V1095-1073', 'V1105-030c', 'V1108-1073', 'V1111-030c', 'V1112-1073',
    'V1113-1073', 'V1121-1073', 'V1122-1073', 'V1124-1073', 'V1125-1073',
    'V1131-1073', 'V1132-1073', 'V1133-0b6f', 'V1135-1073', 'V1136-0b6f',
    'V1139-030c', 'V1141-030c', 'V1141-1073', 'V1143-1073', 'V1147-0b6f',
    'V115-0b6f', 'V1152-1073', 'V1153-1073', 'V1156-1073', 'V1157-1073',
    'V1168-1073', 'V1170-1073', 'V1171-0b6f', 'V1172-1073', 'V1174-1073',
    'V1177-030c', 'V1181-030c', 'V1181-1073', 'V1187-1073', 'V1188-0b6f',
    'V1188-1073', 'V1189-030c', 'V1190-1073',
  ];
  ...
  try {
    ...
    for (final documento in documentosCopiar) {
      ...
      if (snapshot.exists) {
        ...
        print('Documento $documento copiado para imoveis_final_teste com sucesso.');
      } else {
